...
TRAFFIC_FACTOR = {"low": 1.0, "medium": 0.7, "high": 0.4}

CONDITION_FACTOR = {"good": 1.0, "damaged": 0.6, "blocked": 0.1}
...
def compute_priority(request, distance, current_time):
    ...
    priority = severity_score + people_score + waiting_time + distance_factor
